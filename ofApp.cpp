...
void ofApp::draw() {
	...
	for (int radius = 30; radius < 320; radius += 5) {
		...
		int deg_len = ofMap(ofNoise(ofRandom(1000), ofGetFrameNum() * 0.01), 0, 1, -120, 120);

		face.addVertex(glm::vec3());
		face.addColor(ofColor(this->base_color_list[color_index], 32));
